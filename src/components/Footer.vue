<template>
  <div class="mt-10 bg-[#dddddd] pt-3 pb-2 dark:bg-darkmode-light">
    <div>
      <div class="flex flex-col items-center justify-center px-4 text-[#000] dark:text-text-color">
        <p class="mb-3">Contacts:</p>
        <a
          class="flex"
          href="https://t.me/tarasmalchenko"
      ...
      <div>
        <p class="flex items-center justify-center p-2 w-full border-t-2 border-dark mt-3 dark:text-text-color dark:border-darkmode-medium">
          Copyright 2023 <span><font-awesome-icon
            class="ml-2 mt-1"
